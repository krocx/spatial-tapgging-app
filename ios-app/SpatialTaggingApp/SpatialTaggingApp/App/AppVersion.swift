...
//   CFBundleShortVersionString = MARKETING_VERSION          (3 components, e.g. "2026.4.42")
//   CFBundleVersion            = CURRENT_PROJECT_VERSION    (build counter,  e.g. "01")
//
// Display format: YEAR.QUARTER.WEEK.BUILD  (e.g. "2026.4.42.01")
//   YEAR    — Fiscal year
...
//   1. (New week only) Xcode → Project → MARKETING_VERSION: 2026.4.NN
...
enum AppVersion {
    ...
    /// e.g. "2026.4.42.01".  Falls back to "?.?.?.?" if bundle keys are absent
